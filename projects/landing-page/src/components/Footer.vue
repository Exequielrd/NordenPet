    ...
    <v-container class="d-flex">
      <v-col>
        ...
        <address class="footer_address">
          <strong>Direccion</strong> Av Veles Sarfield 4634, Munro Provincia de
          Buenos Aires <strong>Whatsapp</strong> (011) 15-55-69-3758
          <strong>Telefono</strong> (011) 4509-6793
          <strong>Email</strong> ventas@nordenpet.com.ar
        </address>
      </v-col>
      <v-col>
        ...
        <ul class="footer_list">
          ...
          <li>zonas de cobertura para envios</li>
